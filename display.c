...
GtkWidget *
setup_display (GtkWidget * parent)
{
  int wid, hgt;
  ...
  gtk_scrolled_window_add_with_viewport (GTK_SCROLLED_WINDOW
					 (globals.picScroll), globals.picDA);
...
static gint
ExposeCB (GtkWidget * widget, GdkEventExpose * event, gpointer func_data)
{
...
static gint
ResizeCB (GtkWidget * widget, GdkEventConfigure * event, gpointer func_data)
{
  int w, h;
...
static gint
KeyPressEvnt (GtkWidget * widget, GdkEventKey * event, gpointer func_data)
{
...
static gint
KeyReleaseEvnt (GtkWidget * widget, GdkEventKey * event, gpointer func_data)
{
...
static gint
ButtonPressEvnt (GtkWidget * widget, GdkEventButton * event,
		 gpointer func_data)
{
  int xx, yy;
...
static gint
ButtonReleaseEvnt (GtkWidget * widget, GdkEventButton * event,
		   gpointer func_data)
{
  return TRUE;
}
...
resize_window ()
{
  ...
  //gtk_window_resize(GTK_WIDGET(globals.topwin)->window, w, h);
