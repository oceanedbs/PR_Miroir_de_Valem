  ...
  if (!optWindow)
    {
      ...
      gtk_signal_connect (GTK_OBJECT (optWindow), "destroy",
			  GTK_SIGNAL_FUNC (gtk_widget_destroyed), &optWindow);
      ...
      gtk_signal_connect (GTK_OBJECT (button), "toggled",
			  GTK_SIGNAL_FUNC (pix_opt_alg_CB),
			  (gpointer) PIX_SIZE);
      ...
      gtk_signal_connect (GTK_OBJECT (entry), "activate",
			  GTK_SIGNAL_FUNC (pix_size_x_CB), entry);
      ...
      gtk_widget_set_usize (entry, 50, -1);
      gtk_signal_connect (GTK_OBJECT (entry), "activate",
			  GTK_SIGNAL_FUNC (pix_size_y_CB), entry);
      gtk_box_pack_start (GTK_BOX (hbox), entry, FALSE, FALSE, 0);
      gtk_widget_show (entry);
      ...
      gtk_widget_set_usize (entry, 50, -1);
      gtk_signal_connect (GTK_OBJECT (entry), "activate",
			  GTK_SIGNAL_FUNC (pix_count_x_CB), entry);
      gtk_box_pack_start (GTK_BOX (hbox), entry, FALSE, FALSE, 0);
      gtk_widget_show (entry);
      ...
      gtk_widget_set_usize (entry, 50, -1);
      gtk_signal_connect (GTK_OBJECT (entry), "activate",
			  GTK_SIGNAL_FUNC (pix_count_y_CB), entry);
      gtk_box_pack_start (GTK_BOX (hbox), entry, FALSE, FALSE, 0);
      gtk_widget_show (entry);
      ...
      gtk_widget_set_usize (entry, 50, -1);
      gtk_signal_connect (GTK_OBJECT (entry), "activate",
			  GTK_SIGNAL_FUNC (pix_proximity_CB), entry);
...
void
refresh_options_win (struct IMAGE_OPTIONS *im_opt)
{
  char buf[8];
...
void
apply_CB (GtkWidget * widget, GtkWidget * dialog)
{
...
void
pix_opt_alg_CB (GtkWidget * widget, gpointer data)
{
...
void
pix_size_x_CB (GtkWidget * widget, GtkWidget * entry)
{
  gchar *txt;
...
void
pix_size_y_CB (GtkWidget * widget, GtkWidget * entry)
{
  gchar *txt;
  txt = gtk_entry_get_text (GTK_ENTRY (entry));
...
void
pix_count_x_CB (GtkWidget * widget, GtkWidget * entry)
{
  gchar *txt;
  txt = gtk_entry_get_text (GTK_ENTRY (entry));
...
void
pix_count_y_CB (GtkWidget * widget, GtkWidget * entry)
{
  gchar *txt;
  txt = gtk_entry_get_text (GTK_ENTRY (entry));
...
void
pix_proximity_CB (GtkWidget * widget, GtkWidget * entry)
{
  gchar *txt;
  txt = gtk_entry_get_text (GTK_ENTRY (entry));
